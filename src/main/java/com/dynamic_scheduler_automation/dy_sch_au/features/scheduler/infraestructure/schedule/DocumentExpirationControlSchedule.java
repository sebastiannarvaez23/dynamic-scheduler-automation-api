...
@Log4j2
public class DocumentExpirationControlSchedule extends AbstractSchedule {

    private static final String PROCESS = "P0015";

    private final SimulateExecutionService simulateExecutionService;

    private final String companyId;

    public DocumentExpirationControlSchedule(
